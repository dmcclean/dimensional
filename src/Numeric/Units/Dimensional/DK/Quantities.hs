...
(
  ...
  -- $table3
  Frequency, Force, Pressure, Stress, Energy, Work, QuantityOfHeat, Power, RadiantFlux,
  ...
  DFrequency, DForce, DPressure, DStress, DEnergy, DWork, DQuantityOfHeat, DPower, DRadiantFlux,
...
import Numeric.Units.Dimensional.DK
  ( Dimension (Dim), Quantity
  , DThermodynamicTemperature, DPlaneAngle
...
type Angle = Quantity DAngle -- Abbreviation
