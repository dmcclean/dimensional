...
(^) :: (Fractional a, KnownTypeInt i,
        KnownVariant v,
        KnownVariant (Weaken v)) => Dimensional v d a
                                 -> Proxy i
...
The following tables list the units included with the \thispackage{} package.

\begin{table}[htbp]
\caption{SI Units}
\begin{tabular}{lllllll}
Unit Name & Aliases & Abbreviations & Display Form & UCUM & Exact Value & Approximate Value \\
metre    & meter & m  & \si{\metre}     & m  & 1    & 1    \\
gram     &       & g  & \si{\gram}      & g  & 1e-3 & 1e-3 \\
kilogram &       & kg & \si{\kilo\gram} & kg & 1    & 1
\end{tabular}
\end{table}
